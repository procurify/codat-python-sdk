...
api_instance = codat_python_sdk.InvoicesApi(codat_python_sdk.ApiClient(configuration))
...
connection_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 
invoice_id = 'invoice_id_example' # str | 
body = codat_python_sdk.CodatDataContractsDatasetsInvoice() # CodatDataContractsDatasetsInvoice |  (optional)

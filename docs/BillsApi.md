...
api_instance = codat_python_sdk.BillsApi(codat_python_sdk.ApiClient(configuration))
...
connection_id = '38400000-8cf0-11bd-b23e-10b96e4ef00d' # str | 
bill_id = 'bill_id_example' # str | 
body = codat_python_sdk.CodatDataContractsDatasetsBill() # CodatDataContractsDatasetsBill |  (optional)

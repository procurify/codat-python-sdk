...
class BillCreditNotesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __companies_company_id_connections_connection_id_push_bill_credit_notes_post(
            self,
            company_id,
            connection_id,
            **kwargs
        ...
        self.companies_company_id_connections_connection_id_push_bill_credit_notes_post = _Endpoint(
            ...
            callable=__companies_company_id_connections_connection_id_push_bill_credit_notes_post
        )

        def __companies_company_id_data_bill_credit_notes_bill_credit_note_id_get(
            self,
            company_id,
            bill_credit_note_id,
            **kwargs
        ...
        self.companies_company_id_data_bill_credit_notes_bill_credit_note_id_get = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    'company_id': 'companyId',
                    'bill_credit_note_id': 'billCreditNoteId',
                },
                'location_map': {
                    'company_id': 'path',
                    'bill_credit_note_id': 'path',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__companies_company_id_data_bill_credit_notes_bill_credit_note_id_get
        )

        def __companies_company_id_data_bill_credit_notes_get(
            self,
            company_id,
            page=1,
            **kwargs
            ...
            >>> thread = api.companies_company_id_data_bill_credit_notes_get(company_id, page=1, async_req=True)
            >>> result = thread.get()
        ...
        self.companies_company_id_data_bill_credit_notes_get = _Endpoint(
            ...
            api_client=api_client,
            callable=__companies_company_id_data_bill_credit_notes_get
        )

...
class JournalsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __companies_company_id_connections_connection_id_push_journal_entries_post(
            self,
            company_id,
            connection_id,
            **kwargs
            ...
            Keyword Args:
                ...
                codat_data_contracts_datasets_journal_entry (CodatDataContractsDatasetsJournalEntry): [optional]
        ...
        self.companies_company_id_connections_connection_id_push_journal_entries_post = _Endpoint(
            settings={
            ...
            params_map={
                'all': [
                    ...
                    'connection_id',
                    'timeout_in_minutes',
                    'codat_data_contracts_datasets_journal_entry',
                ],
                'required': [
                    'company_id',
                    'connection_id',
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'codat_data_contracts_datasets_journal_entry': 'body',
                },
            ...
            callable=__companies_company_id_connections_connection_id_push_journal_entries_post
        )

        def __companies_company_id_data_journal_entries_get(
            self,
            company_id,
            page=1,
            **kwargs
            ...
            >>> thread = api.companies_company_id_data_journal_entries_get(company_id, page=1, async_req=True)
            >>> result = thread.get()
        ...
        self.companies_company_id_data_journal_entries_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_data_journal_entries_get
        )

        def __companies_company_id_data_journal_entries_journal_entry_id_get(
            self,
            company_id,
            journal_entry_id,
            **kwargs
        ...
        self.companies_company_id_data_journal_entries_journal_entry_id_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_data_journal_entries_journal_entry_id_get
        )

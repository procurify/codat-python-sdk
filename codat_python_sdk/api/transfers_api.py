...
class TransfersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __companies_company_id_connections_connection_id_data_transfers_get(
            self,
            company_id,
            connection_id,
            page=1,
            **kwargs
            ...
            >>> thread = api.companies_company_id_connections_connection_id_data_transfers_get(company_id, connection_id, page=1, async_req=True)
            >>> result = thread.get()
        ...
        self.companies_company_id_connections_connection_id_data_transfers_get = _Endpoint(
            settings={
            ...
            callable=__companies_company_id_connections_connection_id_data_transfers_get
        )

        def __companies_company_id_connections_connection_id_data_transfers_transfer_id_get(
            self,
            company_id,
            connection_id,
            transfer_id,
        ...
        self.companies_company_id_connections_connection_id_data_transfers_transfer_id_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_connections_connection_id_data_transfers_transfer_id_get
        )

        def __companies_company_id_connections_connection_id_push_transfers_post(
            self,
            company_id,
            connection_id,
            **kwargs
            ...
            Keyword Args:
                ...
                codat_data_contracts_datasets_transfer (CodatDataContractsDatasetsTransfer): [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.companies_company_id_connections_connection_id_push_transfers_post = _Endpoint(
            settings={
            ...
            params_map={
                'all': [
                    ...
                    'connection_id',
                    'timeout_in_minutes',
                    'codat_data_contracts_datasets_transfer',
                ],
                'required': [
                    'company_id',
                    'connection_id',
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'codat_data_contracts_datasets_transfer': 'body',
                },
                'collection_format_map': {
                }
            },
            ...
            api_client=api_client,
            callable=__companies_company_id_connections_connection_id_push_transfers_post
        )

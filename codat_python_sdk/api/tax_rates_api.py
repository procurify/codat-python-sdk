...
class TaxRatesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __companies_company_id_data_tax_rates_get(
            self,
            company_id,
            page=1,
            **kwargs
            ...
            >>> thread = api.companies_company_id_data_tax_rates_get(company_id, page=1, async_req=True)
            >>> result = thread.get()
        ...
        self.companies_company_id_data_tax_rates_get = _Endpoint(
            settings={
            ...
            callable=__companies_company_id_data_tax_rates_get
        )

        def __companies_company_id_data_tax_rates_tax_rate_id_get(
            self,
            company_id,
            tax_rate_id,
            **kwargs
        ...
        self.companies_company_id_data_tax_rates_tax_rate_id_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_data_tax_rates_tax_rate_id_get
        )

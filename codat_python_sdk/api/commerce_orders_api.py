...
class CommerceOrdersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __companies_company_id_connections_connection_id_data_commerce_orders_get(
            self,
            company_id,
            connection_id,
            page=1,
            **kwargs
            ...
            >>> thread = api.companies_company_id_connections_connection_id_data_commerce_orders_get(company_id, connection_id, page=1, async_req=True)
            >>> result = thread.get()
        ...
        self.companies_company_id_connections_connection_id_data_commerce_orders_get = _Endpoint(
            settings={
            ...
            callable=__companies_company_id_connections_connection_id_data_commerce_orders_get
        )

        def __companies_company_id_connections_connection_id_data_commerce_orders_order_id_get(
            self,
            company_id,
            connection_id,
            order_id,
        ...
        self.companies_company_id_connections_connection_id_data_commerce_orders_order_id_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_connections_connection_id_data_commerce_orders_order_id_get
        )

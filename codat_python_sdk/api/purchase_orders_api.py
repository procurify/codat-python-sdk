...
class PurchaseOrdersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __companies_company_id_connections_connection_id_push_purchase_orders_post(
            self,
            company_id,
            connection_id,
            **kwargs
            ...
            Keyword Args:
                ...
                codat_data_contracts_datasets_purchase_order (CodatDataContractsDatasetsPurchaseOrder): [optional]
        ...
        self.companies_company_id_connections_connection_id_push_purchase_orders_post = _Endpoint(
            settings={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'codat_data_contracts_datasets_purchase_order': 'body',
                },
            ...
            callable=__companies_company_id_connections_connection_id_push_purchase_orders_post
        )

        def __companies_company_id_connections_connection_id_push_purchase_orders_purchase_order_id_put(
            self,
            company_id,
            connection_id,
            purchase_order_id,
        ...
        self.companies_company_id_connections_connection_id_push_purchase_orders_purchase_order_id_put = _Endpoint(
            settings={
                'response_type': (CodatDataContractsDatasetsPurchaseOrderPushOperation,),
                'auth': [
                    'API Key Auth'
            ...
            api_client=api_client,
            callable=__companies_company_id_connections_connection_id_push_purchase_orders_purchase_order_id_put
        )

        def __companies_company_id_data_purchase_orders_get(
            self,
            company_id,
            page=1,
            **kwargs
            ...
            >>> thread = api.companies_company_id_data_purchase_orders_get(company_id, page=1, async_req=True)
            >>> result = thread.get()
        ...
        self.companies_company_id_data_purchase_orders_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_data_purchase_orders_get
        )

        def __companies_company_id_data_purchase_orders_purchase_order_id_get(
            self,
            company_id,
            purchase_order_id,
            **kwargs
        ...
        self.companies_company_id_data_purchase_orders_purchase_order_id_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_data_purchase_orders_purchase_order_id_get
        )

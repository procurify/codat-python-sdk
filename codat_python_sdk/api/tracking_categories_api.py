...
class TrackingCategoriesApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __companies_company_id_data_tracking_categories_get(
            self,
            company_id,
            page=1,
            **kwargs
            ...
            >>> thread = api.companies_company_id_data_tracking_categories_get(company_id, page=1, async_req=True)
            >>> result = thread.get()
        ...
        self.companies_company_id_data_tracking_categories_get = _Endpoint(
            settings={
            ...
            callable=__companies_company_id_data_tracking_categories_get
        )

        def __companies_company_id_data_tracking_categories_tracking_category_id_get(
            self,
            company_id,
            ...
            **kwargs
            ...
            kwargs['company_id'] = \
                company_id
            kwargs['tracking_category_id'] = \
                tracking_category_id
            return self.call_with_http_info(**kwargs)

        self.companies_company_id_data_tracking_categories_tracking_category_id_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_data_tracking_categories_tracking_category_id_get
        )

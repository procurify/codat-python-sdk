...
class ItemsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __companies_company_id_connections_connection_id_push_items_post(
            self,
            company_id,
            connection_id,
            **kwargs
            ...
            Keyword Args:
                ...
                codat_data_contracts_datasets_item (CodatDataContractsDatasetsItem): [optional]
        ...
        self.companies_company_id_connections_connection_id_push_items_post = _Endpoint(
            settings={
            ...
            params_map={
                'all': [
                    ...
                    'connection_id',
                    'timeout_in_minutes',
                    'codat_data_contracts_datasets_item',
                ],
                'required': [
                    'company_id',
                    'connection_id',
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'codat_data_contracts_datasets_item': 'body',
                },
            ...
            callable=__companies_company_id_connections_connection_id_push_items_post
        )

        def __companies_company_id_data_items_get(
            self,
            company_id,
            page=1,
            **kwargs
            ...
            >>> thread = api.companies_company_id_data_items_get(company_id, page=1, async_req=True)
            >>> result = thread.get()
        ...
        self.companies_company_id_data_items_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_data_items_get
        )

        def __companies_company_id_data_items_item_id_get(
            self,
            company_id,
            item_id,
            **kwargs
        ...
        self.companies_company_id_data_items_item_id_get = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__companies_company_id_data_items_item_id_get
        )

...
class CodatDataContractsDatasetsCommercePlatformTransactionType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """CodatDataContractsDatasetsCommercePlatformTransactionType - a model defined in OpenAPI

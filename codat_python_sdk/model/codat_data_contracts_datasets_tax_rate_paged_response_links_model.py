...
class CodatDataContractsDatasetsTaxRatePagedResponseLinksModel(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """CodatDataContractsDatasetsTaxRatePagedResponseLinksModel - a model defined in OpenAPI
